...
export class IdeaEffects {
  ...
  loadIdeas$: Observable<Action> = this.action$.pipe(
    ofType<fromIdea.LoadIdeas>(fromIdea.LOAD_IDEAS),
  ...
  loadIdea$: Observable<Action> = this.action$.pipe(
    ofType<fromIdea.LoadIdea>(fromIdea.LOAD_IDEA),
    tap(() => this.store.dispatch(new fromError.RemoveError())),
  ...
  createIdeas$: Observable<Action> = this.action$.pipe(
    ofType<fromIdea.CreateIdea>(fromIdea.CREATE_IDEA),
    tap(() => this.store.dispatch(new fromError.RemoveError())),
    mergeMap(action =>
  ...
  updateIdeas$: Observable<Action> = this.action$.pipe(
    ofType<fromIdea.UpdateIdea>(fromIdea.UPDATE_IDEA),
    tap(() => this.store.dispatch(new fromError.RemoveError())),
    mergeMap(action =>
  ...
  deleteIdeas$: Observable<Action> = this.action$.pipe(
    ofType<fromIdea.DeleteIdea>(fromIdea.DELETE_IDEA),
    tap(() => this.store.dispatch(new fromError.RemoveError())),
    mergeMap(action =>
  ...
  upvoteIdeas$: Observable<Action> = this.action$.pipe(
    ofType<fromIdea.UpvoteIdea>(fromIdea.UPVOTE_IDEA),
    tap(() => this.store.dispatch(new fromError.RemoveError())),
    mergeMap(action =>
  ...
  downvoteIdeas$: Observable<Action> = this.action$.pipe(
    ofType<fromIdea.DownvoteIdea>(fromIdea.DOWNVOTE_IDEA),
    tap(() => this.store.dispatch(new fromError.RemoveError())),
    mergeMap(action =>
