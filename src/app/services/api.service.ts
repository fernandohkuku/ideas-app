...
import {Comment, CommentDTO} from "@app/models/commnet"
...
export class ApiService {
  ...
  private api:string = environment.api_serve + '/api'
  constructor(
  ...
  private request(method:string, endpoint:string, body?:any):Observable<any>{
    ...
    return this._http.request(method, url, {body, headers:{authorization:`Bearer ${this.auth.token}`}, })
  }
